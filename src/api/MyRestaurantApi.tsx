...
export const useCreateMyRestaurant = () => {
	...
	const { mutate: createRestaurant, isLoading, isSuccess, isError } = useMutation(createMyRestaurantRequest);
...
export const useUpdateMyRestaurant = () => {
	...
	const { mutate: updateRestaurant, isLoading, isError, isSuccess } = useMutation(updateMyRestaurantRequest);
